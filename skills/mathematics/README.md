...
This folder contains Claude Code Skills for the **Mathematics** domain.

## Maintainer

*Seeking domain maintainer — open an issue if you are a Mathematics expert interested in contributing.*
